...
public class GroupedProductsAdapter extends RecyclerView.Adapter<GroupedProductsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.product_total_price.setText(NumberFormat.getInstance(Locale.US).format((int) totalPrice) + ConstantValues.CURRENCY_SYMBOL);
        ...
        holder.product_quantity_minusBtn.setOnClickListener(view -> {
            ...
            if (number[0] >= 1)
            {
                ...
                holder.product_total_price.setText(NumberFormat.getInstance(Locale.US).format((int) price) + ConstantValues.CURRENCY_SYMBOL);
            }
        });
    
    
        // Increase Product Quantity
        holder.product_quantity_plusBtn.setOnClickListener(view -> {
            ...
            if (productDetails.getStockQuantity() == null ||  number[0] < Long.parseLong(productDetails.getStockQuantity())) {
                ...
                holder.product_total_price.setText(new DecimalFormat("#0.00").format(price) + ConstantValues.CURRENCY_SYMBOL);
            }
        });
    
    
        // View Product Details
        holder.product_cover.setOnClickListener(v -> {
